...
| Tooling          | TypeScript 5, ESLint 9, Drizzle ORM + Supabase (для будущих данных) |
...
Если понадобятся подсказки по контенту/локалям/интеграциям — см. `TODO.md` и комментарии в коде.

---

## План масштабирования

Подробный план развития платформы из лендинга в полноценную систему для организации ивентов находится в файле [`ROADMAP.md`](./ROADMAP.md).
